<!-- modals/AddInventoryItemModal.vue - Updated to use the new supply creation flow -->
<template>
  <Teleport to="body">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transform transition-all duration-300 modal-slide-in">
          ...
          <div class="sticky top-0 bg-gradient-to-r from-blue-50 to-white border-b border-gray-100 px-6 py-4 flex justify-between items-center">
            <div>
              ...
              <p class="text-sm text-gray-500 mt-0.5">Create a new supply item for inventory</p>
            </div>
          ...
          <form @submit.prevent="submit" class="p-6 space-y-5">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-200">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Initial Stock <span class="text-red-500">*</span></label>
                  <input
              ...
              <div class="mt-4 p-3 rounded-lg" :class="getStockStatusClass(form.stock, form.threshold)">
                <div class="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p class="text-sm font-medium">
                    Status Preview: {{ getStockStatus(form.stock, form.threshold) }}
                  </p>
                </div>
              </div>
            </div>
...
async function submit() {
  ...
  // Emit the data - parent will handle creating supply and adding to inventory
